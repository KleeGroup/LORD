...
public class ErreurConstante extends Erreur   {
    	 ...
    	 private static final ResourceBundle RESOURCE_MAP = ResourceBundle
	 ...
	 */
	private ErreurConstante(long numLigne,String errMessage,
            String errColonne,String errValeur,String errFichier){
	 ...
	 */
	public ErreurConstante(long numLigne,String errMessage,
            String errColonne,String errValeur,String errFichier,List<String> errReference){
		this.errLigne=numLigne;
		this.errMessage=errMessage;
		this.errColonne=errColonne;
		this.errValeur=errValeur;
	...
	public static ErreurConstante errCaractereInterdit(long numLigne,String errColonne,String errValeur){
	    ...
	    return new	ErreurConstante(numLigne,
		    errMsg,errColonne,errValeur,"");
	}
	/**
	 ...
	 * @return un objet ErreurConstante
	 */
	public static ErreurConstante errExceptionMoteur(int numLigne,String message
			,String nomFichier){
