...
public class DialogSelectColumnFileModel implements IColumnSeclect {
    private class FileTreeModel implements javax.swing.tree.TreeModel {
	   ...
	   private List<Colonne> colonneFiltre=new ArrayList<Colonne>();
...
/**{@inheritDoc}*/
		...
		if("".equals(filter)){
			...
			if(c.getNom().toLowerCase().contains(filter)
    ...
    private List<Colonne> chosenElements=new ArrayList<Colonne>();
