package spark.reprise.outil.ui;
...
public abstract class UILauncher {
    ...
    private void configureLog4j() {
		...
		URL locConfDefault=ClassLoader.getSystemClassLoader()
		.getResource("log4j.default.properties");
	...
	final URL location=getClass().getProtectionDomain().getCodeSource()
    	.getLocation();
	File parent;
	    try {
