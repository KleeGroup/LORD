...
public class FenetrePrincipaleUtilisateur extends javax.swing.JFrame {
    ...
    .getBundle("resources.FenetrePrincipale");
    ...
    private final List<JComponent> labelsEtapes = new ArrayList<JComponent>();
...
public void actionPerformed(ActionEvent e) {
	...
	setIconImage((new ImageIcon(ClassLoader.
		getSystemResource("resources/images/logo_appli.png"))).getImage());
	...
	jLblLogoKLEE.setIcon(new javax.swing.ImageIcon(ClassLoader
		.getSystemClassLoader().getResource("resources/images/logo_klee.png")));
	jLblLogoKLEE.setName("jLabel5");

	jLblLogoSPARK.setIcon(new javax.swing.ImageIcon(ClassLoader
		.getSystemClassLoader().getResource(
			"resources/images/logo_lord.png")));
	...
	if(status){
	    jBtnQuit.getAction().putValue(
		    Action.NAME, resourceMap.getString("ActnCancel.text"));
	}else{
	    jBtnQuit.getAction().putValue(
		    Action.NAME, resourceMap.getString("ActnQuit.text"));
	}
    }
	...
	if(etat){
	    ...
	    } catch (HeadlessException e) {/**Ne fais rien*/
	    }
	}else{
