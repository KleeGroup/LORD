...
public class Fichier implements IHierarchieSchema {
	 ...
	 * 
	 * @param contrainte
	 *            la contrainte multicol Ã  rajouter
	 * 
	 */
...
//		}
	...
	/**
	 * Remplace la colonne Ã  la position pos , par la colonne c.
	 * 
	 * @param pos
	 *            la position de la colonne Ã  remplacer
	 * @param c
	 *            la nouvelle colonne
	 */
	 ...
	 * 
	 * @param nomColonne
	 *            le nom de la colonne Ã  rajouter
	 */
	...
	/**
	 * Rajoute une liste de colonne Ã  la fin du fichier.
	 * 
	 * @param cols
	 *            les noms des colonnes Ã  rajouter
	 */
	 ...
	 * 
	 * @param pos
	 *            la position de la colonne Ã  supprimer.
	 */
