...
public class ErreurConstante extends Erreur {
	...
	/**
	 * Construit une ErreurConstante ï¿½ partir d'une autre erreur. Les valeurs de
	 * l'autres erreurs sont ï¿½valuï¿½es ï¿½ ce moment et stockï¿½es dans l'objet ErreurConstante
	 *  actuel.
	 * @param err l'erreur ï¿½ convertir.
	 */
	 ...
	 * @param errColonne la colonne de l'erreur
	 * @param errValeur la valeur contenant le caractï¿½re interdit
	...
	/**
	 * renvoie une erreur qui indique que le fichier n'a pas pu ï¿½tre lu.
	 * @param nomFichier le nom de fichier illisible.
	 * @return une erreur qui indique que le fichier n'a pas pu ï¿½tre lu.
	 */
