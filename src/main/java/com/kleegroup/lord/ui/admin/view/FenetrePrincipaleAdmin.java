...
/**
 * FenÃªtre Principale de l'interface administrateur.
 */
public class FenetrePrincipaleAdmin extends JFrame {
	...
	private void adjustTableColumnSize() {
		...
		// on utilise unqiuement les donnÃ©es du premier fichier (selectionnÃ© par dÃ©faut)
	...
	/**
	 * @param nom	la valeur de PrefixNom Ã  afficher Ã  l'utilisateur
	 */
	...
	/**
	 * @param extension	la valeur de l'extension Ã  afficher Ã  l'utilisateur
	 */
	...
	/**
	 * @return le numÃ©ro du groupe du fichier que l'utilisateur a choisi
	 */
	...
	/**
	 * @param value	le seuil d'erreurs Ã  afficher Ã  l'utilisateur
	 */
	...
	/**
	 * @param currentFileMultiColContraintesCount	le nombre de vÃ©rifications Ã  afficher Ã  l'utilisateur
	 */
